...
export class ActivityDefinition {
  private data: Record<string, any> = { resourceType: 'ActivityDefinition' };
  ...
  setAuthor(reference: string, display?: string): this {
    const ref: Record<string, any> = { reference };
    if (display !== undefined) ref['display'] = display;
    this.data['author'] = ref;
    return this;
  }

  setTiming(value: string): this { this.data['timing'] = value; return this; }
}
