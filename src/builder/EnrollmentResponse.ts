...
export class EnrollmentResponse {
  private data: Record<string, any> = { resourceType: 'EnrollmentResponse' };
  ...
  setRequest(reference: string, display?: string): this {
    const ref: Record<string, any> = { reference };
    if (display !== undefined) ref['display'] = display;
    this.data['request'] = ref;
    return this;
  }

  setOutcome(system: string, code: string, display: string = ''): this {
    this.data['outcome'] = { coding: [{ system, code, display }] };
    return this;
  }

  setDisposition(value: string): this { this.data['disposition'] = value; return this; }

  setCreated(value: string): this { this.data['created'] = value; return this; }
}
