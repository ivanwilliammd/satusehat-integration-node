...
export class HealthcareService {
  private data: Record<string, any> = { resourceType: 'HealthcareService' };
  ...
  setLocation(reference: string, display?: string): this {
    const ref: Record<string, any> = { reference };
    if (display !== undefined) ref['display'] = display;
    this.data['location'] = ref;
    return this;
  }

  setProvidedBy(reference: string, display?: string): this {
    const ref: Record<string, any> = { reference };
    if (display !== undefined) ref['display'] = display;
    this.data['providedBy'] = ref;
    return this;
  }
}
