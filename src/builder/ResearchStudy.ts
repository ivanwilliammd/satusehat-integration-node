...
export class ResearchStudy {
  private data: Record<string, any> = { resourceType: 'ResearchStudy' };
  ...
  setProtocol(reference: string, display?: string): this {
    const ref: Record<string, any> = { reference };
    if (display !== undefined) ref['display'] = display;
    this.data['protocol'] = ref;
    return this;
  }

  setSponsor(reference: string, display?: string): this {
    const ref: Record<string, any> = { reference };
    if (display !== undefined) ref['display'] = display;
    this.data['sponsor'] = ref;
    return this;
  }

  setPhase(system: string, code: string, display: string = ''): this {
    this.data['phase'] = { coding: [{ system, code, display }] };
    return this;
  }
}
