...
export class SpecimenDefinition {
  private data: Record<string, any> = { resourceType: 'SpecimenDefinition' };
  ...
  setCollection(value: string): this { this.data['collection'] = value; return this; }

  setPreparation(system: string, code: string, display: string = ''): this {
    this.data['preparation'] = { coding: [{ system, code, display }] };
    return this;
  }
}
