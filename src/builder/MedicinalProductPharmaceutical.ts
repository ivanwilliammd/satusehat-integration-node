...
export class MedicinalProductPharmaceutical {
  private data: Record<string, any> = { resourceType: 'MedicinalProductPharmaceutical' };
  ...
  setRoute(system: string, code: string, display: string = ''): this {
    this.data['route'] = { coding: [{ system, code, display }] };
    return this;
  }

  setDoseForm(system: string, code: string, display: string = ''): this {
    this.data['doseForm'] = { coding: [{ system, code, display }] };
    return this;
  }

  setIngredient(system: string, code: string, display: string = ''): this {
    this.data['ingredient'] = { coding: [{ system, code, display }] };
    return this;
  }
}
