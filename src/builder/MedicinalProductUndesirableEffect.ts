...
export class MedicinalProductUndesirableEffect {
  private data: Record<string, any> = { resourceType: 'MedicinalProductUndesirableEffect' };
  ...
  setSymptomConditionEffect(system: string, code: string, display: string = ''): this {
    this.data['symptomConditionEffect'] = { coding: [{ system, code, display }] };
    return this;
  }

  setClassification(system: string, code: string, display: string = ''): this {
    this.data['classification'] = { coding: [{ system, code, display }] };
    return this;
  }
}
