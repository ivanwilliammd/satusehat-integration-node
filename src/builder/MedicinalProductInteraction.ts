...
export class MedicinalProductInteraction {
  private data: Record<string, any> = { resourceType: 'MedicinalProductInteraction' };
  ...
  setInteractant(system: string, code: string, display: string = ''): this {
    this.data['interactant'] = { coding: [{ system, code, display }] };
    return this;
  }
}
