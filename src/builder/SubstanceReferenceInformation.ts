...
export class SubstanceReferenceInformation {
  private data: Record<string, any> = { resourceType: 'SubstanceReferenceInformation' };
  ...
  setComment(value: string): this { this.data['comment'] = value; return this; }

  setGene(system: string, code: string, display: string = ''): this {
    this.data['gene'] = { coding: [{ system, code, display }] };
    return this;
  }

  setGeneElement(system: string, code: string, display: string = ''): this {
    this.data['geneElement'] = { coding: [{ system, code, display }] };
    return this;
  }
}
