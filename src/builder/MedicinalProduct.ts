...
export class MedicinalProduct {
  private data: Record<string, any> = { resourceType: 'MedicinalProduct' };
  ...
  setProductClass(system: string, code: string, display: string = ''): this {
    this.data['productClass'] = { coding: [{ system, code, display }] };
    return this;
  }
}
