...
export class ExplanationOfBenefit {
  private data: Record<string, any> = { resourceType: 'ExplanationOfBenefit' };
  ...
  setUse(system: string, code: string, display: string = ''): this {
    this.data['use'] = { coding: [{ system, code, display }] };
    return this;
  }

  setPatient(reference: string, display?: string): this {
    const ref: Record<string, any> = { reference };
    if (display !== undefined) ref['display'] = display;
    this.data['patient'] = ref;
    return this;
  }

  setCreated(value: string): this { this.data['created'] = value; return this; }

  setProvider(reference: string, display?: string): this {
    const ref: Record<string, any> = { reference };
    if (display !== undefined) ref['display'] = display;
    this.data['provider'] = ref;
    return this;
  }
}
